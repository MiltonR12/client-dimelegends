...
function RecordForm({ initialValues, isCreate }: Prosp) {
        ...
        <form onSubmit={handleSubmit}
          ...
          <div className='p-7 flex flex-col gap-3' >
            ...
            <div className='flex gap-3 items-center' >
              {!isCreate && <Link
                className='border-zinc-800 bg-zinc-800 border-4 rounded-xl py-2 text-xl mt-3
                w-full text-center'
              ...
              <button
                type="submit"
                className='border-cyan-400 border-4 rounded-xl py-2 text-xl mt-3
                w-full'>
